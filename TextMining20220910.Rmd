...
rawdata <- read.csv(file = "~/MT2022/data/corpus.eval.values.v2.csv", sep = ";")
...
# UC.07 Informationen austauschen
write.xlsx(df, paste("~/MT2022/data/corpus.idx.cv",cv,".xlsx", sep=""))
```
...
# UC.07 Informationen austauschen
write.xlsx(df, paste("~/MT2022/data/corpus.info.cv",cv,".xlsx", sep=""))
```
...
uc07_data <- function(data_object,type,version = T) {
  ...
  if (type == "xlsx") {
    write.xlsx(data_object, paste("~/MT2022/data/",file_name,"_",id,".xlsx", sep=""))
    # print(paste(type,id))
  }
   else if (type == "csv") {
   write.csv(data_object, paste("~/MT2022/data/",file_name,"_",id,".csv", sep=""))
    # print(paste(type,id))
} else if (type == "tbl") {
   write.table(data_object,paste("~/MT2022/data/",file_name,"_",id,".csv", sep=""))
  # print(paste(type,id))
} else {
...
# UC.07 Informationen austauschen
ggsave(paste("~/MT2022/pics/tdm.tf.sparsity.value.eval.ggplot_",cv,".png", sep=""), plot = tdm.tf.sparsity.value.eval.ggplot)
...
# UC.07 Informationen austauschen
ggsave(paste("~/MT2022/pics/tdm.tfidf.sparsity.value.eval.ggplot_",cv,".png", sep = ""), plot = tdm.tfidf.sparsity.value.eval.ggplot)
...
# UC.07 Informationen austauschen
ggsave(file = paste("~/MT2022/pics/tdm.tf.features.reducedby.tfidf.topn_",cv,".pdf", sep = ""), plot = ggplot.all, dpi = 300)
```
...
# UC.07 Informationen austauschen
ggsave(file = paste("~/MT2022/pics/tdm.tfidf.features.reducedby.tfidf.topn_",cv,".pdf", sep = ""), plot = ggplot.all, dpi = 300)
```
...
write.csv(tdm.tf.matrix.sum,file="~/MT2022/data/tdm.tf.matrix.sum.csv")
...
# UC.07 Informationen austauschen
ggsave(file = paste("~/MT2022/pics/tdm.tf.features.reducedby.rst.matrix.topn_",cv,".pdf", sep = ""), plot = ggplot.all, dpi = 300)
```
...
# UC.07 Informationen austauschen
ggsave(file = paste("~/MT2022/pics/tdm.tfidf.features.reducedby.rst.matrix.topn_",cv,".pdf", sep = ""), plot = ggplot.all, dpi = 300)
```
...
# }
# 
# saveWorkbook(uc02_wb,paste("~/MT2022/data/uc02_wb_",cv,".xlsx", sep=""))
